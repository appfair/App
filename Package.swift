...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/ReactiveCocoa/ReactiveCocoa.git", .upToNextMajor(from: "11.2.0")),
    ],
    targets: [
        .target(name: "App", dependencies: [ .product(name: "FairApp", package: "Fair"), "ReactiveCocoa" ], resources: [.process("Resources"), .copy("Bundle")]),
