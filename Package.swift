...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/onevcat/Kingfisher.git", .upToNextMajor(from: "7.1.1")),
    ],
    targets: [
        .target(name: "App", dependencies: [ .product(name: "FairApp", package: "Fair"), "Kingfisher" ], resources: [.process("Resources"), .copy("Bundle")]),
