...
<button style="margin-left: auto; margin-right: auto; text-align: center; user-select: none; background-color: #2171A1; color: #FFFFFF; border: none; padding: 20px 20px; text-decoration: none; display: inline-block; cursor: pointer; border-radius: 20px; user-select: none; display: flex; flex-direction: row;">
    ...
    <div style="padding-left: 16px; padding-right: 16px;">
        ...
        <br />
        <span style="text-align: right; font-size: 16px; color: #FAFAFA; font-family: system-ui, Arial MT, HelveticaNeue, Helvetica Neue;">3.2MB – requires macOS 12+</span>
    </div>
</button>
</a>
</div>   
...
With the App Fair app, you can browse and install native macOS applications from a vast selection of both free and commercial sources. The App Fair supports browsing and installing third-party applications from the homebrew [casks](https://formulae.brew.sh/cask/) tap, as well as accessing free and open-source apps through the [appfair.net](https://appfair.net) distribution platform.

From web browsers like <a href="https://appfair.app/fair#cask/microsoft-edge">Edge</a>, <a href="https://appfair.app/fair#cask/firefox">Firefox</a>, and <a href="https://appfair.app/fair#cask/google-chrome">Chrome</a>, to messaging apps like <a href="https://appfair.app/fair#cask/signal">Signal</a> and <a href="https://appfair.app/fair#cask/discord">Discord</a>, and from media utilities like <a href="https://appfair.app/fair#cask/vlc">VLC</a> and <a href="https://appfair.app/fair#cask/spotify">Spotify</a> to essential tools like <a href="https://appfair.app/fair#cask/sketch">Sketch</a> and <a href="https://appfair.app/fair#cask/docker">Docker</a>, the App Fair is the missing source for the Mac apps that you use each and every day.
<br />
<br />
<br />
<br />
