...
struct WelcomeView : View {
    ...
    static let localizedCards = [
        card("checkmark", color: cardColors.next(),
             ...
             subtitle: NSLocalizedString("about-card-01-caption", bundle: .module, value: "Internet Radio", comment: "app intro card #1 caption markdown"),
             body: NSLocalizedString("about-card-01-content", bundle: .module, value: "Tune-Out enables you to browse, search, and stream internet radio stations from around the world.", comment: "app intro card #1 content markdown")),
