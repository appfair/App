...
public struct WelcomeView : View {
    static let introItems = [
        BannerItem(id: UUID(uuidString: "98213687-6551-4B64-B9F4-E18EA9479708")!, title: "Welcome to **Sun Bow**", subtitle: "Your forever weather buddy", foregroundColor: .init(.white), backgroundColors: [.init(.pink), .init(.purple)], animation: .weatherDayBrokenClouds, body: """
            Welcome to **Sun Bow**. We hope you'll like it here!
            """),
        BannerItem(id: UUID(uuidString: "F5121E79-2902-4068-98D0-5063A7E317C7")!, title: "New Features", subtitle: "The weather never sleeps. Neither do we!", foregroundColor: .init(.white), backgroundColors: [.init(.blue)], animation: .weatherNightScatteredClouds, body: """
            We are constantly making updates and improvements to Sun Bow.
            """),
        BannerItem(id: UUID(uuidString: "F0E7A835-E20F-44AA-9BF7-2947569179B3")!, title: "Global Database Updated", subtitle: "New cities, updated locations", foregroundColor: .init(.white), backgroundColors: [.init(.brown)], animation: .weatherDaySnow, body: """
            Welcome to **Sun Bow**. We hope you'll like it here!
            """),
    ]
    ...
    public var body: some View {
        List {
            ForEach(enumerated: Self.introItems) { index, item in
