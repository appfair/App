...
extension AppCatalogItem {
    ...
    static let sample = AppCatalogItem(name: "App Fair", bundleIdentifier: .init("app.App-Fair"), subtitle: "The App Fair catalog browser app", developerName: "appfair@appfair.net", localizedDescription: "This app allows you to browse, download, and install apps from the App Fair. The App Fair catalog browser is the nexus for finding and installing App Fair apps", size: 1_234_567, version: "1.2.3", versionDate: Date(timeIntervalSinceNow: -60*60*24*2), downloadURL: URL(string: "https://github.com/appfair/App/releases/download/App-Fair/App-Fair-macOS.zip")!, iconURL: URL(string: "https://github.com/appfair/App/releases/download/App-Fair/App-Fair.png")!, screenshotURLs: nil, versionDescription: nil, tintColor: "#FF0000", beta: false, categories: [AppCategory.games.metadataIdentifier], downloadCount: 1_234, impressionCount: nil, viewCount: nil, starCount: 123, watcherCount: 43, issueCount: 12, coreSize: 223_197, sha256: UUID(bytes: rnd).uuidString, permissions: AppEntitlement.allCases.map { AppLegacyPermission(type: $0, usageDescription: "This app needs this entitlement") }.map { .init($0) }, metadataURL: URL(string: "https://github.com/appfair/App/releases/download/App-Fair/App-Fair-macOS.plist"), readmeURL: URL(string: "https://github.com/appfair/App/releases/download/App-Fair/README.md"), releaseNotesURL: URL(string: "https://github.com/appfair/App/releases/download/App-Fair/RELEASE_NOTES.md"), homepage: URL(string: "https://www.appfair.app"))
}
