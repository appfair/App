...
Numeral-IXMCIX can be installed with the [App Fair.app](https://www.appfair.net)
by launching: [appfair://app/Numeral-IXMCIX](appfair://app/Numeral-IXMCIX)
...
```shell
$ brew install appfair/app/numeral-ixmcix
```
